...
export default function suscriptionthankpage() {
    return (
        <div className="max-w-7xl mx-auto m-0 overflow-hidden w-full  px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto my-10 pt-20 md:py-1">
                <h1 className='text-2xl md-text-7xl font-bold px-5 mb-3 md:text-3xl text-center  md:text-center'>Thank you for buying SuperWOD!</h1>
                ...
                <img className='w-25 m-0'  src='https://res.cloudinary.com/dng8o0y7y/image/upload/v1659424223/Landing-page/Thankyou_pay_ldoezs.png' alt="" />
                <Footer />
            </div>
        </div>
    )
