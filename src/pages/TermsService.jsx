        ...
        <div className="bg-gray-50 h-full ">
            ...
            <div className="relative pt-10 px-4 sm:px-6 lg:px-8">
                <div className="text-lg max-w-prose mx-auto">
                    <h1>
                        <span className="mt-7 block text-3xl text-left leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                            Terms of Service
                        </span>
                    </h1>
                    <p className="mt-4 text-base text-left text-gray-900 leading-4">
                ...
                <div className="text-lg max-w-prose mx-auto">
                    <h2>
                        <span className="mt-8 block text-2xl text-left leading-8 font-bold text-gray-900 sm:text-3xl">
                            1) Interperetation
                        </span>
                    </h2>
                    <h2>
                        <span className="mt-4 block text-xl text-left leading-8 font-bold text-gray-900 sm:text-2xl">
                            Interperetation
                        </span>
                    </h2>
                    <p className="mt-3 text-base text-gray-500 leading-8">
                    ...
                    <li className="mt-1 text-base text-gray-500 leading-8">
                    ...
                    <li className="mt-1 text-base text-gray-500 leading-8">
                        <b>Company  </b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SuperWOD Athlete.
                    </li>
                    <li className="mt-1 text-base text-gray-500 leading-8">
                ...
                <div className="text-lg max-w-prose mx-auto">
                    ...
                    <li className="mt-1 text-base text-gray-500 leading-8">
                        <b>By email:</b> asd4703701@gmail.com
                    </li>
                </div>
            </div>
            <Footer />
